...
object FormatUtil {
     ...
     * @return
     */
    fun formatNSAsMSDouble(ns: Long): Double {
        if (ns >= 100000000L) return (ns / 1000000L).toDouble()
        if (ns >= 10000000L) return ns / 100000L / 10.0
        return if (ns >= 1000000L) ns / 10000L / 100.0 else ns / 1000L / 1000.0
    }
}