...
/**
 * interface collection, used for all collection types of Tachyon (array, struct, query)
 */
interface Collection : Dumpable, Iteratorable, Cloneable, Serializable, Castable, ForEachIteratorableCloneable{
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #get(tachyon.runtime.type.Collection.Key)}</code>")
    @Throws(PageException::class)
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #get(tachyon.runtime.type.Collection.Key, Object)}</code>")
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #set(tachyon.runtime.type.Collection.Key, Object)}</code>")
    @Throws(PageException::class)
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #setEL(tachyon.runtime.type.Collection.Key, Object)}</code>")
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #containsKey(tachyon.runtime.type.Collection.Key)}</code>")
