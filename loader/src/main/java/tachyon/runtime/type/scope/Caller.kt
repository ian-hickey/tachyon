...
interface Caller : Scope {
     ...
     */
    val variablesScope: tachyon.runtime.type.scope.Variables?

    /**
     * @return the localScope
     */
    val localScope: tachyon.runtime.type.scope.Local?

    /**
     * @return the argumentsScope
     */
    val argumentsScope: tachyon.runtime.type.scope.Argument?
}