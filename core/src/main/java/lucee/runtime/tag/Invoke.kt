...
class Invoke : BodyTagImpl(), DynamicAttributes {
    ...
    @Override
    fun setDynamicAttribute(uri: String?, localName: lucee.runtime.type.Collection.Key?, value: Object?) {
    ...
    private fun doComponent(oComponent: Object?) {
        ...
        var component: lucee.runtime.Component? = null
        component = if (oComponent is lucee.runtime.Component) oComponent as lucee.runtime.Component? else pageContext.loadComponent(Caster.toString(oComponent))
