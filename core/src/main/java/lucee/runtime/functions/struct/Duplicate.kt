...
class Duplicate : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "Duplicate", 1, 2, args.size)
    }

    companion object {
        private const val serialVersionUID = 74899451528656931L
        fun call(pc: PageContext?, `object`: Object?): Object? {
            return Duplicator.duplicate(`object`, true)
        }

        fun call(pc: PageContext?, `object`: Object?, deepCopy: Boolean): Object? {
