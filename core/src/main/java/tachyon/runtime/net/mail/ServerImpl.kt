...
class ServerImpl(// FUTURE add to interface
    ...
    companion object {
        ...
        fun merge(arr1: Array<tachyon.runtime.net.mail.Server?>?, arr2: Array<tachyon.runtime.net.mail.Server?>?): Array<tachyon.runtime.net.mail.Server?>? {
            val result: ArrayList<tachyon.runtime.net.mail.Server?> = ArrayList<Server?>()
            ...
            return result.toArray(arrayOfNulls<tachyon.runtime.net.mail.Server?>(result.size()))
        }
    }
