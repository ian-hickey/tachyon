...
interface ORMConfiguration {
     ...
     */
    val cfcLocations: Array<tachyon.commons.io.res.Resource?>?
     ...
     */
    val sqlScript: tachyon.commons.io.res.Resource?
     ...
     */
    val cacheConfig: tachyon.commons.io.res.Resource?
     ...
     */
    val ormConfig: tachyon.commons.io.res.Resource?
