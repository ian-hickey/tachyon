...
class VariableUtilImpl : VariableUtil {
    ...
    /**
     * @see tachyon.runtime.util.VariableUtil.set
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     *
     * @see tachyon.runtime.util.VariableUtil.setEL
     */
    @Override
    ...
    /**
     * @see tachyon.runtime.util.VariableUtil.remove
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     * @see tachyon.runtime.util.VariableUtil.callFunction
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     * @see tachyon.runtime.util.VariableUtil.callFunctionWithoutNamedValues
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     * @see tachyon.runtime.util.VariableUtil.callFunctionWithNamedValues
     */
    @Override
    @Throws(PageException::class)
    ...
    companion object {
        ...
        fun doLogReflectionCalls(): Boolean {
            if (_logReflectionCalls == null) _logReflectionCalls = Caster.toBoolean(tachyon.commons.io.SystemUtil.getSystemPropOrEnvVar("tachyon.log.reflection", null), Boolean.FALSE)
