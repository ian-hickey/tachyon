...
class ListCompact : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "ListCompact", 1, 3, args.size)
    }

    companion object {
        private const val serialVersionUID = 533751863889168299L
        ...
        fun call(pc: PageContext?, list: String?, delimiter: String?, multiCharacterDelimiter: Boolean): String? {
