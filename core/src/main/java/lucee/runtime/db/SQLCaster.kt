...
object SQLCaster {
        ...
        return try {
            ...
            when (type) {
                ...
                Types.OTHER -> {
                    ...
                    if (value is lucee.runtime.type.Struct) Caster.toMap(value) else value
                    // toSQLObject(value); TODO alle lucee spezifischen typen sollten in
                }
                else -> {
                    if (value is DateTime) return Date(Caster.toDate(value, null).getTime())
                    if (value is Array) return Caster.toList(value)
    ...
    fun toCFType(sqlType: Int, defaultValue: Short): Short {
        return when (sqlType) {
            Types.ARRAY -> lucee.commons.lang.CFTypes.TYPE_ARRAY
            Types.BIGINT -> lucee.commons.lang.CFTypes.TYPE_NUMERIC
            Types.LONGVARBINARY, Types.VARBINARY, Types.BLOB, Types.BINARY -> lucee.commons.lang.CFTypes.TYPE_BINARY
            Types.BOOLEAN, Types.BIT -> lucee.commons.lang.CFTypes.TYPE_BOOLEAN
            Types.LONGVARCHAR, Types.NVARCHAR, CFTypes.VARCHAR2, Types.VARCHAR, Types.CLOB, Types.CHAR, Types.NCLOB, Types.LONGNVARCHAR, Types.NCHAR -> lucee.commons.lang.CFTypes.TYPE_STRING
            Types.SQLXML -> lucee.commons.lang.CFTypes.TYPE_XML
            Types.TIME, Types.TIMESTAMP, Types.DATE -> lucee.commons.lang.CFTypes.TYPE_DATETIME
            Types.INTEGER, Types.SMALLINT, Types.TINYINT, Types.FLOAT, Types.REAL, Types.DOUBLE, Types.DECIMAL, Types.NUMERIC -> lucee.commons.lang.CFTypes.TYPE_NUMERIC
            else -> defaultValue
        }
    }
}