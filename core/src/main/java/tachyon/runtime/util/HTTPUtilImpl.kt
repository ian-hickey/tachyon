...
class HTTPUtilImpl private constructor() : tachyon.runtime.util.HTTPUtil {
    /**
     * @see tachyon.runtime.util.HTTPUtil.decode
     */
    @Override
    ...
    /**
     * @see tachyon.runtime.util.HTTPUtil.delete
     */
    @Override
    ...
    /**
     * @see tachyon.runtime.util.HTTPUtil.head
     */
    @Override
    @Throws(IOException::class)
    ...
    /**
     * @see tachyon.runtime.util.HTTPUtil.get
     */
    @Override
    @Throws(IOException::class)
    ...
    fun toURL(strUrl: String?, port: Int, encodeIfNecessary: Boolean): URL? {
        return tachyon.commons.net.HTTPUtil.toURL(strUrl!!, port, if (encodeIfNecessary) tachyon.commons.net.HTTPUtil.ENCODED_AUTO else tachyon.commons.net.HTTPUtil.ENCODED_NO)
    }

    /**
     * @see tachyon.commons.net.HTTPUtil.toURL
     */
    @Override
    @Throws(MalformedURLException::class)
    fun toURL(strUrl: String?): URL? {
        return tachyon.commons.net.HTTPUtil.toURL(strUrl!!, tachyon.commons.net.HTTPUtil.ENCODED_AUTO)
    }

    @Override
    @Throws(URISyntaxException::class)
    fun toURI(strUrl: String?): URI? {
        return tachyon.commons.net.HTTPUtil.toURI(strUrl)
    }

    @Override
    @Throws(URISyntaxException::class)
    fun toURI(strUrl: String?, port: Int): URI? {
        return tachyon.commons.net.HTTPUtil.toURI(strUrl, port)
    }
    ...
    companion object {
        private val instance: tachyon.runtime.util.HTTPUtil? = HTTPUtilImpl()
        fun getInstance(): tachyon.runtime.util.HTTPUtil? {
            return instance
        }
    }
}