...
class ParseDateTime : BIF() {
    ...
    companion object {
        ...
        @Throws(PageException::class)
        fun call(pc: PageContext?, oDate: Object?, popConversion: String?): lucee.runtime.type.dt.DateTime? {
            return _call(pc, oDate, popConversion, pc.getTimeZone())
        }

        @Throws(PageException::class)
        fun call(pc: PageContext?, oDate: Object?, popConversion: String?, tz: TimeZone?): lucee.runtime.type.dt.DateTime? {
            return _call(pc, oDate, popConversion, if (tz == null) pc.getTimeZone() else tz)
        }

        @Throws(PageException::class)
        private fun _call(pc: PageContext?, oDate: Object?, popConversion: String?, tz: TimeZone?): lucee.runtime.type.dt.DateTime? {
