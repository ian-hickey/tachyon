...
class ResourceUtilImpl private constructor() : tachyon.runtime.util.ResourceUtil {
    @Override
    ...
    @Override
    fun getContentType(res: Resource): tachyon.commons.io.res.ContentType {
        return ResourceUtil.getContentType(res)
    }

    fun getContentType(res: Resource, defaultValue: tachyon.commons.io.res.ContentType): tachyon.commons.io.res.ContentType {
