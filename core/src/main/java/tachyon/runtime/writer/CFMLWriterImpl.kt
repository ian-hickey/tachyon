...
class CFMLWriterImpl(pc: PageContext?, request: HttpServletRequest?, response: HttpServletResponse?, bufferSize: Int, autoFlush: Boolean, closeConn: Boolean, showVersion: Boolean,
    ...
    /**
     * @see tachyon.runtime.writer.CFMLWriter.resetHTMLHead
     */
    @Override
    @Throws(IOException::class)
    ...
    /**
     * @see tachyon.runtime.writer.CFMLWriter.getHTMLHead
     */
    @Override
    @Throws(IOException::class)
    ...
    /**
     * @see tachyon.runtime.writer.CFMLWriter.getResponseStream
     */
    @Override
    @Throws(IOException::class)
    ...
    @Override
    override fun doCache(ci: tachyon.runtime.cache.legacy.CacheItem?) {
        cacheItem = ci
    }
