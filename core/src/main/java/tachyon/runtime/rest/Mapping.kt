...
class Mapping(config: Config?, virtual: String?, physical: String?, hidden: Boolean, readonly: Boolean, _default: Boolean) {
    ...
    companion object {
        ...
        private val _FILTER_LUCEE: ResourceFilter? = AndResourceFilter(arrayOf<ResourceFilter?>(ExtensionResourceFilter(Constants.getTachyonComponentExtension()), object : ResourceFilter() {
            @Override
            fun accept(res: Resource?): Boolean {
