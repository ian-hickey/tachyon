...
class DebugTimerImpl(private val label: String?, private val time: Long, private val template: String?) : DebugTimer {
    /**
     * @return the label
     */
    @Override
    ...
    companion object {
        private const val serialVersionUID = -4552972253450654830L
    }
}