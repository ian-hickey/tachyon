...
class FunctionLibFactory : DefaultHandler {
    ...
    companion object {
        ...
        private val FLD_LUCEE: String? = "/resource/fld/core-lucee.fld"
        ...
        fun loadFromSystem(id: Identification?): Array<FunctionLib?>? {
            if (systemFLDs!![CFMLEngine.DIALECT_CFML] == null) {
                ...
                val lucee: FunctionLib = cfml!!.duplicate(false)
                lucee.transformer.library.function.FunctionLibFactory.Companion.systemFLDs.get(CFMLEngine.DIALECT_CFML) = lucee.transformer.library.function.FunctionLibFactory(cfml, lucee.transformer.library.function.FunctionLibFactory.Companion.FLD_CFML, id, true).getLib()
                lucee.transformer.library.function.FunctionLibFactory.Companion.systemFLDs.get(CFMLEngine.DIALECT_LUCEE) = lucee.transformer.library.function.FunctionLibFactory(lucee, lucee.transformer.library.function.FunctionLibFactory.Companion.FLD_LUCEE, id, true).getLib()
            }
            return systemFLDs
        }
