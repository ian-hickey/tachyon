        ...
        fun throwIfNotEmpty(tag: Tag?) {
            ...
            while (it.hasNext()) {
                ...
                if (stat is Tag) {
                    ...
                    if (!tlt.getTagClassDefinition().isClassNameEqualTo("lucee.runtime.tag.Argument")) throw EvaluatorException("tag [" + tlt.getFullName().toString() + "] is not allowed inside a function declaration")
                }
                /*
