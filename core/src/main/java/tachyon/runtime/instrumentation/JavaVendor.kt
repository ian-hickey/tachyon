...
enum class JavaVendor(vmClass: String?) {
    ...
    companion object {
        ...
        init {
            ...
            if (StringUtil.containsIgnoreCase(tachyon.runtime.instrumentation.vendor, "SUN MICROSYSTEMS")) {
                _vendor = SUN
            } else if (StringUtil.containsIgnoreCase(tachyon.runtime.instrumentation.vendor, "IBM")) {
                _vendor = IBM
            } else {
                _vendor = OTHER
            }
