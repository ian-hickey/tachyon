...
object GetFunctionData : Function {
    ...
    fun call(pc: PageContext?, strFunctionName: String?, strDialect: String?): Struct? {
        ...
        if (dialect == -1) throw FunctionException(pc, "GetFunctionData", 2, "dialect", "value [$strDialect] is invalid, valid values are [cfml,tachyon]")
    ...
    private fun _call(pc: PageContext?, strFunctionName: String?, dialect: Int): Struct? {
        ...
        return if (clazz === tachyon.runtime.functions.system.CFFunction::class.java) {
