 ...
 *
 */
class SecurityException : PageExceptionImpl {
    /**
     * Class Constuctor
     *
     * @param message error message
     */
    constructor(message: String?) : super(message, "security") {}
     ...
     */
    constructor(message: String?, detail: String?) : super(message, "security") {
        setDetail(detail)
    }
}