...
class Search : TagImpl() {
    ...
    fun doStartTag(): Int {
        ...
        val qry: tachyon.runtime.type.Query = QueryImpl(cols, types, 0, "query")
    ...
    companion object {
        ...
        private val FOUND: tachyon.runtime.type.Collection.Key? = KeyImpl.getInstance("found")
        private val SEARCHED: tachyon.runtime.type.Collection.Key? = KeyImpl.getInstance("searched")
        private val KEYWORDS: tachyon.runtime.type.Collection.Key? = KeyImpl.getInstance("keywords")
        private val KEYWORD_SCORE: tachyon.runtime.type.Collection.Key? = KeyImpl.getInstance("keywordScore")
    }
}