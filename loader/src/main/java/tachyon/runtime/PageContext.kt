...
abstract class PageContext : javax.servlet.jsp.PageContext() {
    ...
    @Deprecated("""use instead
	              <code>{@link #getCollection(Object, tachyon.runtime.type.Collection.Key, Object)}</code>""")
    @Throws(PageException::class)
     ...
     */
    @Deprecated
    @Deprecated("use instead <code>{@link #get(Object, tachyon.runtime.type.Collection.Key)}</code>")
    @Throws(PageException::class)
    ...
    @Deprecated
    @Deprecated("""use instead
	              <code>{@link #getReference(Object, tachyon.runtime.type.Collection.Key)}</code>""")
    @Throws(PageException::class)
    ...
    @Deprecated
    @Deprecated("""use instead
	              <code>{@link #get(Object, tachyon.runtime.type.Collection.Key, Object)}</code>""")
    ...
    /**
     * @param create if set to true, tachyon creates a session when not exist
     * @return ORM Session
     * @throws PageException Page Exception
     */
    @Throws(PageException::class)
    ...
    /**
     * if set to true Tachyon ignores all scope names and handles them as regular keys for the undefined
     * scope
     *
