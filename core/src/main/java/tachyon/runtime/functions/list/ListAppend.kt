...
class ListAppend : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "ListAppend", 2, 4, args.size)
    }

    companion object {
        private const val serialVersionUID = -4893447489733907241L
        ...
        fun call(pc: PageContext?, list: String?, value: String?, delimiter: String?, includeEmptyFields: Boolean): String? {
            ...
            return StringBuilder(list).append(del).append(value).toString()
        }
    }
}