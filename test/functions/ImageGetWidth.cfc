...
component extends="org.tachyon.cfml.test.TachyonTestCase" labels="image" {
	...
	public void function testVariableName() localmode="true"{
		assertEquals(92,imageGetWidth("variables.image"));
	}

	public void function testBinary() localmode="true"{
		assertEquals(92,imageGetWidth(variables.binary));
	}

	public void function testBase64() localmode="true"{
		assertEquals(92,imageGetWidth("data:image/png;base64,"&variables.base64));
	}
} 
</cfscript>