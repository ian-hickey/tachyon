...
object TimeZoneConstants {
    val UTC: TimeZone = TimeZone.getTimeZone("UTC")
    val GMT: TimeZone = TimeZone.getTimeZone("GMT")
    val GMT0: TimeZone = TimeZone.getTimeZone("GMT0")
    val EUROPE_LONDON: TimeZone = TimeZone.getTimeZone("Europe/London")
    val CET: TimeZone = TimeZone.getTimeZone("CET") /*
