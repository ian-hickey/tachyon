...
class TransfomerSettings(// private static final TransfomerSettings TRANS_SETTING_DOT_NOT_UPPER = new
        ...
        val dotNotationUpper: Boolean, val handleUnQuotedAttrValueAsString: Boolean, val ignoreScopes: Boolean)