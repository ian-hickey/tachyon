...
class ConfigWebHelper(cs: ConfigServerImpl?, cw: ConfigWebPro?) {
    ...
    private var baseComponentPageTachyon: CIPage? = null
    ...
    fun getBaseComponentPage(dialect: Int, pc: PageContext?): CIPage? {
        ...
        // Tachyon
        if (baseComponentPageTachyon == null) {
            baseComponentPageTachyon = cw!!.getBaseComponentPageSource(dialect, pc).loadPage(pc, false) as CIPage
        }
        return baseComponentPageTachyon
    }
