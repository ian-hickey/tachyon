...
class StructImplString : StructImpl, Struct {
    ...
    /**
     * @see lucee.runtime.type.Collection.get
     */
    @Override
    ...
    /**
     * @see lucee.runtime.type.Collection.set
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     * @see lucee.runtime.type.Collection.setEL
     */
    @Override
    ...
    /**
     * @see lucee.runtime.type.Collection.remove
     */
    @Override
    @Throws(PageException::class)
    ...
    /**
     *
     * @see lucee.runtime.type.Collection.removeEL
     */
    @Override
    ...
    /**
     * @see lucee.runtime.type.Collection.duplicate
     */
    @Override
    ...
    /**
     * @see lucee.runtime.type.util.StructSupport.castToString
     */
    @Override
    ...
    /**
     * @see lucee.runtime.op.Castable.castToBoolean
     */
    @Override
    ...
    /**
     * @see lucee.runtime.op.Castable.compare
     */
    @Override
    @Throws(ExpressionException::class)
    ...
    /**
     * @see lucee.runtime.op.Castable.compareTo
     */
    @Override
    @Throws(PageException::class)
