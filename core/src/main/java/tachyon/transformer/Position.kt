...
class Position     // print.e(line+":"+column+":"+position);
(val line: Int, val column: Int, val pos: Int) {
    @Override
    override fun toString(): String {
        return StringBuilder("line:").append(line).append(";column:").append(column).append(";pos:").append(pos).toString()
    }
}