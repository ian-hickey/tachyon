...
class FunctionNotSupported : ExpressionException {
    constructor(functionName: String?) : super("Function [$functionName] is not supported/implemented") {}
    constructor(functionName: String?, sub: String?) : super("Function [$functionName] with [$sub] is not supported/implemented") {}
}