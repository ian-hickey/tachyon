...
class ListChangeDelims : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "ListChangeDelims", 2, 5, args.size)
    }

    companion object {
        private const val serialVersionUID = 8979553735693035787L
        @Throws(PageException::class)
        fun call(pc: PageContext?, list: String?, newDel: String?): String? {
            return call(pc, list, newDel, ",", false, false)
        }

        @Throws(PageException::class)
        fun call(pc: PageContext?, list: String?, newDel: String?, oldDel: String?): String? {
            return call(pc, list, newDel, oldDel, false, false)
        }

        @Throws(PageException::class)
        fun call(pc: PageContext?, list: String?, newDel: String?, oldDel: String?, includeEmptyFields: Boolean): String? {
            return call(pc, list, newDel, oldDel, includeEmptyFields, false)
        }

        @Throws(PageException::class)
        fun call(pc: PageContext?, list: String?, newDel: String?, oldDel: String?, includeEmptyFields: Boolean, multiCharacterDelimiter: Boolean): String? {
