...
object Types {
    ...
    val ARRAY_IMPL: Type? = Type.getType(tachyon.runtime.type.ArrayImpl::class.java)
    ...
    val COMPONENT: Type? = Type.getType(tachyon.runtime.Component::class.java)
    ...
    val COMPONENT_PAGE_IMPL: Type? = Type.getType(tachyon.runtime.ComponentPageImpl::class.java)
    val INTERFACE_PAGE_IMPL: Type? = Type.getType(InterfacePageImpl::class.java)
    val COMPONENT_IMPL: Type? = Type.getType(tachyon.runtime.ComponentImpl::class.java)
    val INTERFACE_IMPL: Type? = Type.getType(tachyon.runtime.InterfaceImpl::class.java)
    val DATE_TIME: Type? = Type.getType(tachyon.runtime.type.dt.DateTime::class.java)
    ...
    val QUERY: Type? = Type.getType(tachyon.runtime.type.Query::class.java)
    val QUERY_COLUMN: Type? = Type.getType(tachyon.runtime.type.QueryColumn::class.java)
    ...
    val STRUCT: Type? = Type.getType(tachyon.runtime.type.Struct::class.java)
    val STRUCT_IMPL: Type? = Type.getType(tachyon.runtime.type.StructImpl::class.java)
    ...
    val TIMESPAN: Type? = Type.getType(tachyon.runtime.type.dt.TimeSpan::class.java)
    ...
    val BIF: Type? = Type.getType(tachyon.runtime.ext.function.BIF::class.java)
    val DATA_MEMBER: Type? = Type.getType(tachyon.runtime.component.DataMember::class.java)
     ...
     * @param type
     * @return
     * @throws tachyon.runtime.exp.TemplateExceptionption
     */
    ...
    fun toType(bc: BytecodeContext?, type: String?): Type? {
        ...
        when (first) {
            ...
            'l' -> {
                ...
                if ("tachyon.runtime.type.Collection\$Key".equals(type)) return COLLECTION_KEY
            }
            'n' -> {
    ...
    fun toClass(type: Type?): Class? {
        ...
        if (DATE_TIME.equals(type)) return tachyon.runtime.type.dt.DateTime::class.java
