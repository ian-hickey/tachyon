...
class NullKeyLockListener private constructor() : KeyLockListener {
    @Override
    override fun onEnd(key: String?, isLast: Boolean) {
    }

    @Override
    override fun onStart(key: String?, isFirst: Boolean) {
    }

    companion object {
        private val my = NullKeyLockListener()
        val instance: tachyon.commons.lang.lock.KeyLockListener
            get() = my
    }
}