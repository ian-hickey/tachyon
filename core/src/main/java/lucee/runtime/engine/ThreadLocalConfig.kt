 ...
 */
object ThreadLocalConfig {
    private val cThreadLocal: ThreadLocal? = ThreadLocal()
     ...
     */
    fun register(config: Config?) { // DO NOT CHANGE, used in Ortus extension via reflection
     ...
     */
    fun get(): Config? {
        return cThreadLocal.get() as Config
    }

    /**
     * release the pagecontext for the current thread
     */
    fun release() { // DO NOT CHANGE, used in Ortus extension via reflection
