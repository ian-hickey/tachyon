component extends="Cache" {
    ...
    fields=[
		...
		field("Disable out of memory handling","outOfMemory","false",false,"When the JVM runs out of memory, Tachyon will prune elements from the cache automatically to avoid Out Of Memeory errors.  In case you want to PREVENT this, enable this setting.","checkbox","true")
		
	];
    
    public string function getClass() {
    	return "tachyon.runtime.cache.ram.RamCache";
    }
