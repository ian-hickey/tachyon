...
object LSParseDateTime : Function {
    ...
    fun call(pc: PageContext?, oDate: Object?): lucee.runtime.type.dt.DateTime? {
        return _call(pc, oDate, pc.getLocale(), pc.getTimeZone(), null)
    }

    @Throws(PageException::class)
    fun call(pc: PageContext?, oDate: Object?, locale: Locale?): lucee.runtime.type.dt.DateTime? {
        return _call(pc, oDate, if (locale == null) pc.getLocale() else locale, pc.getTimeZone(), null)
    }

    @Throws(PageException::class)
    fun call(pc: PageContext?, oDate: Object?, locale: Locale?, strTimezoneOrFormat: String?): lucee.runtime.type.dt.DateTime? {
    ...
    @Throws(PageException::class)
    fun call(pc: PageContext?, oDate: Object?, locale: Locale?, strTimezone: String?, strFormat: String?): lucee.runtime.type.dt.DateTime? {
    ...
    @Throws(PageException::class)
    private fun _call(pc: PageContext?, oDate: Object?, locale: Locale?, tz: TimeZone?, format: String?): lucee.runtime.type.dt.DateTime? {
        var locale: Locale? = locale
        var tz: TimeZone? = tz
