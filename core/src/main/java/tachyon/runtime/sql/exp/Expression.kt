 ...
 *
 */
package tachyon.runtime.sql.exp
...
interface Expression {
    ...
    fun toString(noAlias: Boolean): String?

    // Recursively resets any cached data in the expression and any of it's composed expressions
    fun reset()

    // Recursively sets the cached column flag in the expression and any of it's composed expressions
    fun setCacheColumn(cacheColumn: Boolean)
    var isDirectionBackward: Boolean
}