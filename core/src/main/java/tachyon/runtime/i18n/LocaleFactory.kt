...
object LocaleFactory {
    ...
    init {
        ...
        for (i in tachyon.runtime.i18n.ls.indices) {
            tachyon.runtime.i18n.key = tachyon.runtime.i18n.ls.get(i).getDisplayName(Locale.US).toLowerCase()
            locales.put(tachyon.runtime.i18n.key, tachyon.runtime.i18n.ls.get(i))
            if (tachyon.runtime.i18n.key.indexOf(',') !== -1) {
                tachyon.runtime.i18n.key = tachyon.runtime.i18n.ls.get(i).toString()
                // print.ln(key);
            }
            if (i > 0) tachyon.runtime.i18n.sb.append(",")
            tachyon.runtime.i18n.sb.append(tachyon.runtime.i18n.key)
        }
        localeList = tachyon.runtime.i18n.sb.toString()
