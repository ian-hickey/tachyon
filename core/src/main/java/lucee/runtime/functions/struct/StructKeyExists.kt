...
class StructKeyExists : BIF() {
    ...
    companion object {
        ...
        fun call(pc: PageContext?, struct: lucee.runtime.type.Struct?, key: String?): Boolean {
            return call(pc, struct, KeyImpl.init(key))
        }

        fun call(pc: PageContext?, struct: lucee.runtime.type.Struct?, key: Collection.Key?): Boolean {
