...
object Base64Util {
    ...
    init {
        ...
        run {
            val j = 0
            while (lucee.runtime.coder.i <= 51) {
                lookUpBase64Alphabet!![lucee.runtime.coder.i] = (97 + lucee.runtime.coder.j) as Byte
                lucee.runtime.coder.i++
                lucee.runtime.coder.j++
            }
        }
        lucee.runtime.coder.i = 52
        val j = 0
        while (lucee.runtime.coder.i <= 61) {
            lookUpBase64Alphabet!![lucee.runtime.coder.i] = (48 + lucee.runtime.coder.j) as Byte
            lucee.runtime.coder.i++
            lucee.runtime.coder.j++
        }
