...
class Output : EvaluatorSupport() {
    ...
    companion object {
        private val ENCODE_FOR_: String? = "org.tachyon.extension.esapi.functions.EncodeFor" // EncodeForCSS.class.getName();
        private val ESAPI_ENCODE: String? = "org.tachyon.extension.esapi.functions.ESAPIEncode"
