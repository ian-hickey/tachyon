...
class Lambda : Function {
    constructor(root: Root?, name: Expression?, returnType: Expression?, returnFormat: Expression?, output: Expression?, bufferOutput: Expression?, access: Int, displayName: Expression?,
    ...
    constructor(root: Root?, name: String?, access: Int, modifier: Int, returnType: String?, body: Body?, start: Position?, end: Position?) : super(name, access, modifier, returnType, body, start, end) {}
