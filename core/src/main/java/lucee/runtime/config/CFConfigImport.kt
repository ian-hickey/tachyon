    ...
    fun execute(): Struct? {
        ...
        return try {
            ...
            if (Util.isEmpty(password)) {
                val sysprop = "lucee." + type.toUpperCase().toString() + ".admin.password"
            ...
            tag = engine.getClassUtil().loadClass("lucee.runtime.tag.Admin").newInstance() as Tag
            ...
            set(pc, json, "updateComponent", Item("componentUseVariablesScope", "useshadow"), Item("componentdumptemplate"),
                    Item(arrayOf("componentDeepSearch"), "deepsearch", null).setDefault(false), Item("basecomponenttemplatelucee"), Item("componentpathcache"),
