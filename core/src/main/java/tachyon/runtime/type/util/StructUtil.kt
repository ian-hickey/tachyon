...
object StructUtil {
    ...
    fun toCollectionKeys(skeys: Array<String?>?): Array<tachyon.runtime.type.Collection.Key?>? {
        val keys: Array<tachyon.runtime.type.Collection.Key?> = arrayOfNulls<tachyon.runtime.type.Collection.Key?>(skeys!!.size)
    ...
    fun duplicate(sct: Struct?, deepCopy: Boolean): Struct? {
        ...
        // tachyon.runtime.type.Collection.Key[] keys=sct.keys();
