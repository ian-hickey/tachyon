...
class PageSourceImpl : PageSource {
    ...
    fun isComponent(): Boolean {
        ...
        return if (getDialect() == CFMLEngine.DIALECT_CFML) Constants.isCFMLComponentExtension(ext) else Constants.isTachyonComponentExtension(ext)
    }
    ...
    fun getDialect(): Int {
        ...
        if (!(c as ConfigPro).allowTachyonDialect()) return CFMLEngine.DIALECT_CFML
