...
class Execute : BodyTagImpl() {
    ...
    fun setArguments(args: Object?) {
        if (args is tachyon.runtime.type.Collection) {
            arguments = ArrayList<String?>()
            val coll: tachyon.runtime.type.Collection? = args as tachyon.runtime.type.Collection?
    ...
    companion object {
        ...
        fun main(args: Array<String?>?) {
            val cr: CommandResult = Command.execute("curl https://update.tachyon.org/rest/update/provider/echoGet", true)
            val e = _Execute(null, null, arrayOf<String?>("curl", "https://update.tachyon.org/rest/update/provider/echoGet"), null, null, null, null, null)
            e!!._run(null)
        }
    }
}