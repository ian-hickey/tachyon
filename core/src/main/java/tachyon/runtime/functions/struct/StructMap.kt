...
class StructMap : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "StructMap", 2, 4, args.size)
    }
    ...
    companion object {
        ...
        @Throws(PageException::class)
        private fun _call(pc: PageContext?, sct: Struct?, udf: UDF?, parallel: Boolean, maxThreads: Int): Struct? {
            return Map.call(pc, sct, udf, parallel, maxThreads, null, ClosureFunc.TYPE_STRUCT) as Struct?
        }
    }
}