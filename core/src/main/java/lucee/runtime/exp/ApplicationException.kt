 ...
 */
class ApplicationException : PageExceptionImpl {
    /**
     * Constructor of the Application Object
     *
     * @param message Exception Message
     */
    constructor(message: String?) : super(message, "application") {}
     ...
     */
    constructor(message: String?, detail: String?) : super(message, "application") {
        setDetail(detail)
    }
}