...
class ValueDate : ValueSupport, Literal {
    private override var value: DateTime?

    constructor(value: DateTime?) : super(value.toString()) {
        this.value = value
    }

    constructor(strValue: String?) : super(strValue) {
        value = Caster.toDate(strValue, false, null)
    }
