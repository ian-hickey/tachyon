...
interface ConfigPro : Config {
    ...
    fun getRestMappings(): Array<lucee.runtime.rest.Mapping?>?
    ...
    fun getDatasourceConnectionPool(ds: lucee.runtime.db.DataSource?, user: String?, pass: String?): DatasourceConnPool?
