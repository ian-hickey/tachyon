...
class XMLConfigReader(file: Resource?, trimBody: Boolean, readRule: ReadRule?, nameRule: NameRule?) : DefaultHandler(), LexicalHandler {
    ...
    companion object {
        ...
        fun main(args: Array<String?>?) {
            var src: Resource = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Projects/Tachyon/Tachyon5/core/src/main/java/resource/config/web.xml")
            var trg: Resource = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Projects/Tachyon/Tachyon5/core/src/main/java/resource/config/web.json")
            ConfigWebFactory.translateConfigFile(null, src, trg, "", false)
            src = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Projects/Tachyon/Tachyon5/core/src/main/java/resource/config/server.xml")
            trg = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Projects/Tachyon/Tachyon5/core/src/main/java/resource/config/server.json")
            ConfigWebFactory.translateConfigFile(null, src, trg, "single", true)

            // src =
            // ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/webapps/ROOT/WEB-INF/tachyon/tachyon-web.xml.cfm");
            // trg =
            // ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/webapps/ROOT/WEB-INF/tachyon/tachyon-web.json");
            // ConfigWebFactory.translateConfigFile(null, src, trg);

            // src =
            // ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/tachyon-server/context/tachyon-server.xml");
            // trg =
            // ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/tachyon-server/context/tachyon-server.json");
            // ConfigWebFactory.translateConfigFile(null, src, trg);
            src = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/webapps/ROOT/WEB-INF/tachyon/.CFConfig.json")
            src.delete()
            src = ResourcesImpl.getFileResourceProvider().getResource("/Users/mic/Test/test/tachyon-server/context/.CFConfig.json")
            src.delete()

            /*
		 * XMLConfigReader reader = new XMLConfigReader(res, true, new ReadRule(), new NameRule()); String
		 * str = ser(reader.getData().get("cfTachyonConfiguration")); IOUtil.write(trg, str, CharsetUtil.UTF8,
		 * false); print.e(str);
		 */
