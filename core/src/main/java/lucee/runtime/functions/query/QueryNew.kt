...
class QueryNew : BIF() {
    ...
    companion object {
        ...
        @Throws(PageException::class)
        fun call(pc: PageContext?, columnNames: Object?): lucee.runtime.type.Query? {
        ...
        @Throws(PageException::class)
        fun call(pc: PageContext?, columnNames: Object?, columnTypes: Object?): lucee.runtime.type.Query? {
        ...
        @Throws(PageException::class)
        fun call(pc: PageContext?, columnNames: Object?, columnTypes: Object?, data: Object?): lucee.runtime.type.Query? {
            val cn: Array? = toArray(pc, columnNames, 1)
            val qry: lucee.runtime.type.Query?
