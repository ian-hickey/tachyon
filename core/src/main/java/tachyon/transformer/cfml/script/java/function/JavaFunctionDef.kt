...
class JavaFunctionDef(javaClassName: Class<*>?, javaMethodName: String?, args: Array<Class<*>?>?, rtn: Class<*>?, throwException: Boolean) : FunctionDef {
    ...
    override fun createSourceCode(ps: PageSource?, javaCode: String?, id: String?, functionName: String?, access: Int, modifier: Int, hint: String?, listArgs: List<Argument?>?,
     ...
     tachyon.loader.engine.CFMLEngine engine = CFMLEngineFactory.getInstance();
    ...
    private fun outerShell(ps: PageSource?, pack: String?, className: String?, id: String?, functionName: String?, javaFunctionClass: Class<*>?,
        ...
        sb.append("import tachyon.runtime.PageContext;\n")
        sb.append("import tachyon.runtime.config.Config;\n")
        sb.append("import tachyon.runtime.type.Query;\n")
        sb.append("import tachyon.runtime.ext.function.BIF;\n")
        sb.append("import tachyon.loader.engine.CFMLEngineFactory;\n")
        sb.append("import tachyon.runtime.Component;\n")
        sb.append("import tachyon.runtime.PageSource;\n")
        sb.append("import tachyon.runtime.dump.DumpData;\n")
        sb.append("import tachyon.runtime.type.FunctionArgument;\n")
        sb.append("import tachyon.loader.engine.CFMLEngine;\n")
        sb.append("import tachyon.runtime.exp.PageException;\n")
        sb.append("import tachyon.runtime.type.Struct;\n")
        sb.append("import tachyon.runtime.dump.DumpProperties;\n")
        sb.append("import tachyon.runtime.type.UDF;\n")
        sb.append("import tachyon.runtime.type.Collection.Key;\n")
        sb.append("import tachyon.runtime.op.Caster;\n")
        sb.append("import tachyon.runtime.type.FunctionArgumentImpl;\n")
        sb.append("public class $className")
        sb.append(" extends tachyon.runtime.JF ")
...
""")
    ...
    private fun createGetFunctionArguments(argNames: Array<String?>?, argHints: Array<String?>?): String? {
        ...
        for (i in argNames.indices) {
            if (i > 0) sb.append(',')
            sb.append("new FunctionArgumentImpl(tachyon.runtime.type.KeyImpl.intern(").append(esc(argNames!![i])).append("),").append(esc(Caster.toClassName(args!![i]))).append(",")
    ...
    protected fun caster(sb: StringBuilder?, clazz: Class<*>?) {
        if (Long::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toLongValue(") else if (Long::class.java === clazz) sb.append("engine.getCastUtil().toLong(") else if (Double::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toDoubleValue(") else if (Double::class.java === clazz) sb.append("engine.getCastUtil().toDouble(") else if (Int::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toIntValue(") else if (Integer::class.java === clazz) sb.append("engine.getCastUtil().toInteger(") else if (Boolean::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toBooleanValue(") else if (Boolean::class.java === clazz) sb.append("engine.getCastUtil().toBoolean(") else if (Char::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toCharValue(") else if (Character::class.java === clazz) sb.append("engine.getCastUtil().toCharacter(") else if (Short::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toShortValue(") else if (Short::class.java === clazz) sb.append("engine.getCastUtil().toShort(") else if (Byte::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toByteValue(") else if (Byte::class.java === clazz) sb.append("engine.getCastUtil().toByte(") else if (Float::class.javaPrimitiveType === clazz) sb.append("engine.getCastUtil().toFloatValue(") else if (Float::class.java === clazz) sb.append("engine.getCastUtil().toFloat(") else if (Array::class.java === clazz) sb.append("engine.getCastUtil().toArray(") else if (BigDecimal::class.java === clazz) sb.append("engine.getCastUtil().toBigDecimal(") else if (ByteArray::class.java === clazz) sb.append("engine.getCastUtil().toBinary(") else if (Collection::class.java === clazz) sb.append("engine.getCastUtil().toCollection(") else if (Component::class.java === clazz) sb.append("engine.getCastUtil().toComponent(") else if (File::class.java === clazz) sb.append("engine.getCastUtil().toFile(") else if (Iterator::class.java === clazz) sb.append("engine.getCastUtil().toIterator(") else if (Locale::class.java === clazz) sb.append("engine.getCastUtil().toLocale(") else if (Map::class.java === clazz) sb.append("engine.getCastUtil().toMap(") else if (Array<Object>::class.java === clazz) sb.append("engine.getCastUtil().toNativeArray(") else if (Node::class.java === clazz) sb.append("engine.getCastUtil().toNode(") else if (NodeList::class.java === clazz) sb.append("engine.getCastUtil().toNodeList(") else if (Query::class.java === clazz) sb.append("engine.getCastUtil().toQuery(") else if (String::class.java === clazz) sb.append("engine.getCastUtil().toString(") else if (Struct::class.java === clazz) sb.append("engine.getCastUtil().toStruct(") else if (TimeSpan::class.java === clazz) sb.append("engine.getCastUtil().toTimeSpan(") else if (TimeZone::class.java === clazz) sb.append("engine.getCastUtil().toTimeZone(") else if (Object::class.java === clazz) sb.append("(") else if (BigInteger::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toBigInteger(") else if (CharSequence::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toCharSequence(") else if (UDF::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toFunction(") else if (MutableCollection::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toJavaCollection(") else if (List::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toList(") else if (Date::class.java === clazz) sb.append("tachyon.runtime.op.Caster.toDate(") else sb.append("(" + Caster.toClassName(clazz).toString() + ")tachyon.runtime.op.Caster.castTo(\"" + Caster.toClassName(clazz).toString() + "\",")
