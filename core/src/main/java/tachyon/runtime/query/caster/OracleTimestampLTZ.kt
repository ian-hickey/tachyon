...
class OracleTimestampLTZ : Cast {
    ...
    override fun toCFType(tz: TimeZone?, rst: ResultSet?, columnIndex: Int): Object? {
        ...
        return try {
            val ts: Timestamp = Reflector.callMethod(o, "timestampValue", arrayOf<Object?>(rst.getStatement().getConnection(), JREDateTimeUtil.getThreadCalendar(tz))) as Timestamp
