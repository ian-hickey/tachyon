...
class CacheSetProperties : BIF() {
    ...
    companion object {
        ...
        private fun setProperties(cc: CacheConnection?, properties: Struct?) {
            throw SecurityException("it is not allowed to change cache connection setting this way, please use the tag cfadmin or the Tachyon administrator frontend instead ")
        }
