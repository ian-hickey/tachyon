...
object CacheUtil {
    ...
    fun getDefault(pc: PageContext?, type: Int): Cache? {
        ...
        val cc: CacheConnection = (config as ConfigPro).getCacheDefaultConnection(type)
                ?: throw CacheException("there is no default " + toStringType(type, "") + " cache defined, you need to define this default cache in the Lucee Administrator")
     ...
     */
    @Throws(lucee.runtime.exp.SecurityException::class)
