...
class DecisionIntVisitor {
    ...
    companion object {
        val GT: Int = Opcodes.IF_ICMPGT
        val GTE: Int = Opcodes.IF_ICMPGE
        val LT: Int = Opcodes.IF_ICMPLT
        val LTE: Int = Opcodes.IF_ICMPLE
        val EQ: Int = Opcodes.IF_ICMPEQ
        val NEQ: Int = Opcodes.IF_ICMPNE
    }
}