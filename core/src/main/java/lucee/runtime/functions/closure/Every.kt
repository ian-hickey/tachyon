...
class Every : BIF(), ClosureFunc {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "Every", 2, 4, args.size)
    }
    ...
    companion object {
        ...
        @Throws(PageException::class)
        fun call(pc: PageContext?, obj: Object?, udf: UDF?, parallel: Boolean, maxThreads: Double, type: Short): Boolean {
            return _call(pc, obj, udf, parallel, maxThreads.toInt(), type)
        }
        ...
        private fun _call(pc: PageContext?, obj: Object?, udf: UDF?, parallel: Boolean, maxThreads: Int, type: Short): Boolean {
            ...
            } else throw FunctionException(pc, "Every", 1, "data", "cannot iterate througth this type " + Caster.toTypeName(obj.getClass()))
