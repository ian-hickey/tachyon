...
class ArrayAsArrayList private constructor(array: Array?) : ArrayList(), Cloneable {
    var array: Array?
    @Override
    ...
    @Override
    fun clone(): Object {
        return toArrayList(Duplicator.duplicate(array, true) as Array)
    }

    @Override
    fun ensureCapacity(minCapacity: Int) {
        throw PageRuntimeException("not supported")
    }
    ...
    companion object {
        fun toArrayList(array: Array?): ArrayList? {
            return ArrayAsArrayList(array)
        }
    }
