...
class FileTag : BodyTagImpl() {
    ...
    private var securityManager: tachyon.runtime.security.SecurityManager? = null
    ...
    companion object {
         ...
         */
        @Throws(PageException::class)
        fun actionMove(pageContext: PageContext?, securityManager: tachyon.runtime.security.SecurityManager?, source: Resource?, strDestination: String?, nameconflict: Int,
         ...
         */
        @Throws(PageException::class)
        fun actionCopy(pageContext: PageContext?, securityManager: tachyon.runtime.security.SecurityManager?, source: Resource?, strDestination: String?, nameconflict: Int,
                       serverPassword: String?, acl: Object?, mode: Int, attributes: String?) {
            var nameconflict = nameconflict
            if (nameconflict == NAMECONFLICT_UNDEFINED) nameconflict = NAMECONFLICT_OVERWRITE
            if (source == null) throw ApplicationException("Attribute [source] is required for tag [file], when the action is [" + actionValue + "]",
        ...
        @Throws(PageException::class)
        fun actionUpload(pageContext: PageContext?, securityManager: tachyon.runtime.security.SecurityManager?, filefield: String?, strDestination: String?, nameconflict: Int,
        ...
        @Throws(PageException::class)
        fun actionUploadAll(pageContext: PageContext?, securityManager: tachyon.runtime.security.SecurityManager?, strDestination: String?, nameconflict: Int, accept: String?,
        ...
        @Throws(PageException::class)
        private fun _actionUpload(pageContext: PageContext?, securityManager: tachyon.runtime.security.SecurityManager?, formItem: FormItem?, strDestination: String?, nameconflict: Int,
                                  accept: String?, allowedExtensions: ResourceFilter?, blockedExtensions: ResourceFilter?, strict: Boolean, mode: Int, attributes: String?, acl: Object?, serverPassword: String?): Struct? {
            var nameconflict = nameconflict
        ...
        private fun getFormItem(pageContext: PageContext?, filefield: String?): FormItem? {
            ...
            if (pe != null) throw pe
            val upload: tachyon.runtime.type.scope.Form = pageContext.formScope()
