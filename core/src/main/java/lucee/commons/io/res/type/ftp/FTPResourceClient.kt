...
class FTPResourceClient(ftpConnectionData: FTPConnectionData, cacheTimeout: Int) : FTPClient() {
    ...
    private val files: Map<String, FTPFileWrap> = MapFactory.< String, FTPFileWrap>getConcurrentMap<String?, lucee.commons.io.res.type.ftp.FTPResourceClient.FTPFileWrap?>()
