...
object TagUtil {
    ...
    fun setDynamicAttribute(attributes: StructImpl?, name: Collection.Key?, value: Object?, caseType: Short) {
        ...
        if (name.equalsIgnoreCase(KeyConstants._attributecollection)) {
            if (value is lucee.runtime.type.Collection) {
                val coll: lucee.runtime.type.Collection? = value as lucee.runtime.type.Collection?
     ...
     * @param config
     */
    fun addTagMetaData(cw: ConfigWebPro?, log: lucee.commons.io.log.Log?) {
