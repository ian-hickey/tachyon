...
@Deprecated
@Deprecated("use instead tachyon.commons.net.URLEncoder")
object URLEncoder {
    ...
    init {
        ...
        run {
            val i = 'a'.toInt()
            while (tachyon.commons.lang.i <= 'z'.toInt()) {
                WWW_FORM_URL.set(tachyon.commons.lang.i)
                tachyon.commons.lang.i++
            }
        }
        run {
            val i = 'A'.toInt()
        ...
        // numeric characters
        val i = '0'.toInt()
        while (tachyon.commons.lang.i <= '9'.toInt()) {
            WWW_FORM_URL.set(tachyon.commons.lang.i)
            tachyon.commons.lang.i++
        }
    }
