...
class ListMap : BIF() {
    ...
    operator fun invoke(pc: PageContext?, args: Array<Object?>?): Object? {
        ...
        throw FunctionException(pc, "ListMap", 2, 7, args.size)
    }
    ...
    companion object {
         ...
         *
         */
        private const val serialVersionUID = 259806095458506715L
        @Throws(PageException::class)
        ...
        fun call(pc: PageContext?, list: String?, filter: UDF?, delimiter: String?, includeEmptyFields: Boolean, multiCharacterDelimiter: Boolean, parallel: Boolean,
            ...
            return ListUtil.arrayToList(Map.call(pc, StringListData(list, delimiter, includeEmptyFields, multiCharacterDelimiter), filter, parallel, maxThreads) as Array?,
                    delimiter)
        }
    }
}