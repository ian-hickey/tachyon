...
class JavaProxy : JavaObject {
    ...
    constructor(obj: Object?) : super(ThreadLocalPageContext.get().getVariableUtil(), obj) {}

    @Throws(Exception::class)
    operator fun invoke(methodName: String?, args: Array<Object?>?, pc: PageContext?): Object? {
