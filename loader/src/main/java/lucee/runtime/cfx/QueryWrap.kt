...
class QueryWrap : Query, Cloneable {
    private val rst: lucee.runtime.type.Query
     ...
     */
    constructor(rst: lucee.runtime.type.Query) {
        this.rst = rst
        name = rst.getName()
    }
     ...
     */
    constructor(rst: lucee.runtime.type.Query, name: String) {
        this.rst = rst
        this.name = name
    }
    ...
    val query: lucee.runtime.type.Query
        get() = rst
