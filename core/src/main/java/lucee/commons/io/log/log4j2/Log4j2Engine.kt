...
class Log4j2Engine(config: Config) : LogEngine() {
    ...
    fun appenderClassDefintion(className: String?): ClassDefinition {
        ...
        return if ("datasource".equalsIgnoreCase(className) || "lucee.commons.io.log.log4j.appender.DatasourceAppender".equals(className)
    ...
    fun layoutClassDefintion(className: String): ClassDefinition<*> {
        ...
        if ("datasource".equalsIgnoreCase(className) || "lucee.commons.io.log.log4j.layout.DatasourceLayout".equals(className)) return ClassDefinitionImpl(ClassicLayout::class.java)
