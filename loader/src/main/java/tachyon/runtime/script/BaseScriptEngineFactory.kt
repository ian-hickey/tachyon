 ...
 *
 */
package tachyon.runtime.script
...
abstract class BaseScriptEngineFactory(tag: Boolean, dialect: Int) : ScriptEngineFactory {
    ...
    init {
        try {
            System.setProperty("tachyon.cli.call", "true")

            // returns null when not used within Tachyon
            ...
            if (engine == null) {
                ...
                var rootPath: String = System.getProperty("tachyon.cli.contextRoot")
