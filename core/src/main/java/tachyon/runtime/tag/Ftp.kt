...
class Ftp : TagImpl() {
    ...
    companion object {
        ...
        @Throws(PageException::class)
        fun toQuery(files: Array<FTPFile?>?, prefix: String?, directory: String?, hostName: String?): tachyon.runtime.type.Query? {
            ...
            val query: tachyon.runtime.type.Query = QueryImpl(cols, types, 0, "query")
