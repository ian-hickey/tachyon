...
class Exit : TagImpl() {
    ...
    fun doEndTag(): Int {
        ...
        val insideCT = thistagObj != null && thistagObj is lucee.runtime.type.Collection
        // executebody

        // Inside Custom Tag
        if (insideCT) {
            val thistag: lucee.runtime.type.Collection = thistagObj as lucee.runtime.type.Collection
            // executionmode
